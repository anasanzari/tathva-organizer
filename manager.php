...
<?php require './includes/header.php'; ?>
    ...
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#eventm" aria-controls="eventm" role="tab" data-toggle="tab">Manage Event</a></li>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="eventm">
                
                <h1><?=$event->getName()?></h1>
                <h2>Event Code: <?=$event->getCode()?></h2>
                <a href="showevent.php?eventcode=<?=$event->getCode()?>" target="_blank" class="btn btn-default btn-lg">Show Event Details</a>
                <a href="event.php?eventcode=<?=$event->getCode()?>" target="_blank" class="btn btn-default btn-lg">Edit Event</a>
